    ...
    public static function flush()
    {
        if (Security::database_is_ready() && Director::is_cli() && false === self::$done) {
            ...
            register_shutdown_function(function () {
                ...
                if (! Director::isLive()) {
                    $user = Environment::getEnv('SS_BASIC_AUTH_USER') ?: Environment::getEnv('SS_BASIC_AUTH_USERNAME') ?: Environment::getEnv('SS_DEFAULT_ADMIN_USERNAME') ?: Environment::getEnv('SS_DEFAULT_ADMIN_USERNAME');
